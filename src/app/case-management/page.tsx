...
import { FileText, Filter, Loader2, RefreshCcw, Search } from 'lucide-react';
 ...
 * Case detail is at /cases/[id] (shared with register).
 */
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="outline" size="sm" asChild>
                    <Link href="/cases">Case register</Link>
                  </Button>
                </div>
              </div>
            </CardHeader>
                    ...
                    {isLoadingCases ? (
                      ...
                      <TableRow>
                        <TableCell colSpan={6} className="text-center py-8">
                          ...
                          <Button asChild variant="outline" className="mt-4">
                            <Link href="/cases">Go to Case register</Link>
                          </Button>
                        </TableCell>
                      </TableRow>
                    ) : (
                      cases.map((caseItem: CaseRegisterDto) => (
                        <TableRow key={caseItem.id} className="hover:bg-muted/30">
                          ...
                          <TableCell>
                            <Button variant="outline" size="sm" asChild>
                              <Link href={`/cases/${caseItem.id}?from=case-management`}>Open</Link>
                            </Button>
                          </TableCell>
                        </TableRow>
                      ))
