        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Configure password policies, backups, shift settings, and audit logs. 2FA is managed in your profile.</p>
            </div>
              ...
              <Card className="p-6">
                <form onSubmit={passwordForm.handleSubmit(handlePasswordPolicySave)} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="passwordExpiryDays">Password Expiry (days, 0 = no expiry)</Label>
                      <Input
                        id="passwordExpiryDays"
                        type="number"
                        min={0}
                        max={365}
                        {...passwordForm.register('passwordExpiryDays', { valueAsNumber: true })}
                        disabled={!canEdit}
                      />
                    </div>
                  </div>
