...
NEXT_PUBLIC_API_URL=${NEXT_PUBLIC_API_URL:-"https://truloadapi.codevertexitsolutions.com"}
NEXT_PUBLIC_WS_URL=${NEXT_PUBLIC_WS_URL:-"wss://truloadapi.codevertexitsolutions.com/ws"}
