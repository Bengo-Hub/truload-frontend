...
NEXT_PUBLIC_API_URL=${NEXT_PUBLIC_API_URL:-"https://truloadapi.codevertexafrica.com"}
NEXT_PUBLIC_WS_URL=${NEXT_PUBLIC_WS_URL:-"wss://truloadapi.codevertexafrica.com/ws"}
